package com.workshop.store.config;
...
import com.workshop.store.entities.Payment;
import com.workshop.store.entities.Product;
import com.workshop.store.entities.User;
import com.workshop.store.entities.emums.OrderStatus;
import com.workshop.store.repositories.CategoryRepository;
import com.workshop.store.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.AWAITING_PAYMENT, u2);
        Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.AWAITING_PAYMENT, u1);
